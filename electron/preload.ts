...
contextBridge.exposeInMainWorld('serigraphica', {
  ...
  exportDewarped: (imagePath: string, rectangles: unknown[], quality: number, outputBasePath?: string, meshCurve?: number, centerLargestInnerHorizontal?: boolean, centerLargestInnerVertical?: boolean, fillShapes?: unknown[], fillSampleRegions?: unknown[]) =>
    ipcRenderer.invoke('export-dewarped', imagePath, rectangles, quality, outputBasePath, meshCurve, centerLargestInnerHorizontal, centerLargestInnerVertical, fillShapes, fillSampleRegions),
  exportDewarpedAs: (imagePath: string, rectangles: unknown[], quality: number, outputBasePath?: string, meshCurve?: number, centerLargestInnerHorizontal?: boolean, centerLargestInnerVertical?: boolean, fillShapes?: unknown[], fillSampleRegions?: unknown[]) =>
    ipcRenderer.invoke('export-dewarped-as', imagePath, rectangles, quality, outputBasePath, meshCurve, centerLargestInnerHorizontal, centerLargestInnerVertical, fillShapes, fillSampleRegions),
  previewDewarped: (imagePath: string, rectangles: unknown[], quality: number, outputBasePath?: string, meshCurve?: number, centerLargestInnerHorizontal?: boolean, centerLargestInnerVertical?: boolean) =>
    ipcRenderer.invoke('preview-dewarped', imagePath, rectangles, quality, outputBasePath, meshCurve, centerLargestInnerHorizontal, centerLargestInnerVertical),
